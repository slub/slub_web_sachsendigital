...
$(function() {
    ...
    $('button.nav-open').on('click', function(event) {
        setTimeout(function() { $('body').addClass('menu-open'); }, 25);
    });
    ...
    $('.tx-dlf-listview ol.tx-dlf-abstracts > li').each(function() { if(!$(this).find('ol.tx-dlf-volume')[0]) { $(this).addClass('no-subs'); } });
    ...
    if ($('.selected-logos .institute-logo')[0]) {
        $('.selected-logos .institute-logo').sort(function () {
